...
export function Projects(){
    ...
    return (
        ...
        <div className="sticky top-0 flex h-screen items-center overflow-hidden">
            <motion.div style={{ x }} className="flex gap-8 px-6 max-md:gap-2">
                <a href="https://lembre-lembre-app.vercel.app/fotos/" className="flex flex-col bg-gray-800 rounded-xl overflow-hidden shadow-lg hover:scale-105 transition-transform duration-300 max-w-[500px]  max-md:max-w-[260px]">
                ...
                <a href="https://baliarquitetura.com/" className="flex flex-col bg-gray-800 rounded-xl overflow-hidden shadow-lg hover:scale-105 transition-transform duration-300 max-w-[500px] max-md:max-w-[260px]">
                ...
                <a href="https://dt-money-mv.vercel.app/" className="flex flex-col bg-gray-800 rounded-xl overflow-hidden shadow-lg hover:scale-105 transition-transform duration-300 max-w-[500px]  max-md:max-w-[260px]">
